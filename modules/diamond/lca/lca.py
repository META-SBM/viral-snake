if __name__ == "__main__":
    ...
    for cnt in diam_res['qseqid'].unique():
        ...
        result = run(f"echo '{ancestors}'| taxonkit lca --data-dir {taxdump} -s ';'| cut -f2 | taxonkit lineage --data-dir {taxdump} -R", 
        ...
        tophit_res = run(f"echo '{top_hit_id}'| taxonkit lca --data-dir {taxdump} -s ';'| cut -f2 | taxonkit lineage --data-dir {taxdump} -R", 
