rule subsample_reads:
    ...
    output:
        r1 = "{fs_prefix}/{dataset}/reads/{qc_filter}__subsample_{n_reads}/{sample}_R1.fastq.gz",
        r2 = "{fs_prefix}/{dataset}/reads/{qc_filter}__subsample_{n_reads}/{sample}_R2.fastq.gz"
    params:
        seed = 42  # Random seed for reproducibility
    threads: 1
    log:
        "{fs_prefix}/{dataset}/reads/{qc_filter}__subsample_{n_reads}/{sample}.log"
    conda:
        "../../envs/seqtk.yaml"
    shell:
        """
